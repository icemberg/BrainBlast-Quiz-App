...
import { User, ShieldCheck, Lock, ArrowLeft, Zap } from 'lucide-react';
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 mt-2 text-sm">
                        {loginType === 'admin' ? 'Enter admin credentials to continue.' : 'Sign in to access your quizzes.'}
                    </p>
                </div>
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-[#1a1a1a] text-gray-500">Or continue with credentials</span>
                    </div>
                </div>
                ...
                <div className="flex bg-white/5 p-1 rounded-xl mb-8 border border-white/5">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-bold transition-all ${loginType === 'user'
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <motion.button
                        ...
                        type="submit"
                        disabled={loading}
                        className={`w-full py-4 rounded-xl font-bold text-lg shadow-xl shadow-purple-900/20 transition-all ${loginType === 'admin'
                    ...
                    >
                        {loading ? (
                            ...
                            loginType === 'admin' ? 'Login to Dashboard' : 'Start Quizzing'
                        )}
                    </motion.button>
                </form>
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-400 text-sm">
                        ...
                        <Link to="/register" className="text-white font-bold hover:text-purple-400 transition-colors">
                            Sign up for free
                        </Link>
                    </p>
                </div>
